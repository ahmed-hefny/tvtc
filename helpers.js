         ...
         libContainer.innerHTML +=
            ...
            <div class="col-lg-4 col-md-6 col-12 mb-3">
               <div class="px-3 py-3 shadow-lg d-flex flex-column justify-content-between box text-decoration-none rounded-3 ">
                  ...
                  <div>   
                     <a href="${libraries[i].phone ? 'tel:+' + libraries[i].phone : 'javascript:void(0)'}" class="d-block text-decoration-none text-end py-1" dir="ltr">
                        ${libraries[i].phone ? libraries[i].phone : 'غير متوفر رقم هاتف'}
                        </a>
                        <a href="${libraries[i].map}" target="_blank" class="d-block text-decoration-none">
                           إضغط للذهاب للخريطة
                     </a>
                  </div>
               </div>
